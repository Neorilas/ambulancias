...
| Eventos | Asignación activada (cron o botón) · fotos de inicio completas · **asignación sin iniciar 15 min después de su hora** (además hace sonar la alarma de la app, abajo) · asignación finalizada (vale también por «fotos de fin», que no se manda aparte) |
