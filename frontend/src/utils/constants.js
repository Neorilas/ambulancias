...
// Subconjuntos por sección del wizard de cierre
export const IMAGEN_TIPOS_FIN_EXTERIOR = [FRONTAL, LATERAL_IZQUIERDO, TRASERA, LATERAL_DERECHO];
export const IMAGEN_TIPO_CUENTAKILOMETROS = CUENTAKILOMETROS;
